...
function AddEmployee({user,setUser}) {
  ...
  function submit(e){
    ...
    if(errorMessage){
      setErrorMessage('Invalid or incomplete form')
    }else{
      setLoading(true)
         ...
         <form onSubmit={(e)=>submit(e)} className='employeeForm'>
            ...
            <div className="div2">
                ...
                <div className="contactNumberDiv">
                  ...
                  <input type="number" name="contactNumber" className='form-control' placeholder='Contact Number' required onChange={(e) => setContactNumber(e.target.value)}/>
                </div>
